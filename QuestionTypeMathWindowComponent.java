...
public class QuestionTypeMathWindowComponent extends JFrame
{
	...
	public QuestionTypeMathWindowComponent()
	{
		//QUESTION PANEL
	...
	class continueButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			{
				setVisible(false);
				GeneralQuestionMathWindowComponent generalQues = new GeneralQuestionMathWindowComponent();
				generalQues.setVisible(true);
			}
			else if (makeAppointmentButton.isSelected())
			{
				setVisible(false);
				AppointmentTypeMathWindowComponent mathAppointment = new AppointmentTypeMathWindowComponent();
				mathAppointment.setVisible(true);
			}
		}
	}
