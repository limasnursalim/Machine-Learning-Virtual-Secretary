...
public class AppointmentCS 
{
	...
	public AppointmentCS(String teacher, String day, String time)
	{
	...
	{
		File CSAppointment = new File(teacher + " CS Appointment.txt");
	...
	{
		PrintWriter out = new PrintWriter(new File(teacher + " CS Appointment.txt"));
